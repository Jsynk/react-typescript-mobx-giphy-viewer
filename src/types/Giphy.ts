// To parse this data:
//
//   import { Convert, Giphy } from "./file";
//
//   const giphy = Convert.toGiphy(json);
//
...
export class Convert {
    public static toGiphy(json: string): Giphy {
        return cast(JSON.parse(json), r("Giphy"));
    }

    public static giphyToJson(value: Giphy): string {
        return JSON.stringify(uncast(value, r("Giphy")), null, 2);
    }
}
...
const typeMap: any = {
    ...
    "Data": o([
        ...
        { json: "is_sticker", js: "is_sticker", typ: true },
        ...
        { json: "is_anonymous", js: "is_anonymous", typ: true },
        { json: "is_community", js: "is_community", typ: true },
        { json: "is_featured", js: "is_featured", typ: true },
        { json: "is_hidden", js: "is_hidden", typ: true },
        { json: "is_indexable", js: "is_indexable", typ: true },
        { json: "is_preserve_size", js: "is_preserve_size", typ: true },
        { json: "is_realtime", js: "is_realtime", typ: true },
        { json: "is_removed", js: "is_removed", typ: true },
        { json: "is_dynamic", js: "is_dynamic", typ: true },
    ], false),
    "Analytics": o([
    ...
    "User": o([
        ...
        { json: "suppress_chrome", js: "suppress_chrome", typ: true },
